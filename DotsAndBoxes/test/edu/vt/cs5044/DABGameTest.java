...
///////////////////////////// test 3x3 Game ///////////////////////////////
    ...
    /*
     * initialized game 3x3 +------+------+------+ | box | box | box | |(0, 0)|(1, 0)|(2, 0)|
     * +------+------+------+ | box | box | box | |(0, 1)|(1, 1)|(2, 1)| +------+------+------+ |
     * box | box | box | |(0, 2)|(1, 2)|(2, 2)| +------+------+------+
     *
     */
    ...
    public void testGame3x3() {
        ...
        System.out.println("Draw Edge (Player One, 0,0 LEFT): " +
            game.drawEdge(coord00, Direction.LEFT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,0 RIGHT): " +
            game.drawEdge(coord00, Direction.RIGHT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 0,0 TOP): " +
            game.drawEdge(coord00, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,0 BOTTOM): " +
            game.drawEdge(coord00, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 0,0): " +
            game.getOwnerAt(coord00));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,0 LEFT): " +
            game.drawEdge(coord10, Direction.LEFT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,0 RIGHT): " +
            game.drawEdge(coord10, Direction.RIGHT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 1,0 TOP): " +
            game.drawEdge(coord10, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,0 BOTTOM): " +
            game.drawEdge(coord10, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 1,0): " +
            game.getOwnerAt(coord10));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,0 LEFT): " +
            game.drawEdge(coord20, Direction.LEFT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,0 RIGHT): " +
            game.drawEdge(coord20, Direction.RIGHT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 2,0 TOP): " +
            game.drawEdge(coord20, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,0 BOTTOM): " +
            game.drawEdge(coord20, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 2,0): " +
            game.getOwnerAt(coord20));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,1 LEFT): " +
            game.drawEdge(coord01, Direction.LEFT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 0,1 RIGHT): " +
            game.drawEdge(coord01, Direction.RIGHT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,1 TOP): " +
            game.drawEdge(coord01, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,1 BOTTOM): " +
            game.drawEdge(coord01, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 0,1): " +
            game.getOwnerAt(coord01));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,1 LEFT): " +
            game.drawEdge(coord11, Direction.LEFT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,1 RIGHT): " +
            game.drawEdge(coord11, Direction.RIGHT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 1,1 TOP): " +
            game.drawEdge(coord11, Direction.TOP));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 1,1 BOTTOM): " +
            game.drawEdge(coord11, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player One, 1,1): " +
            game.getOwnerAt(coord11));
        ...
        System.out.println();
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 2,1 LEFT): " +
            game.drawEdge(coord21, Direction.LEFT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 2,1 RIGHT): " +
            game.drawEdge(coord21, Direction.RIGHT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,1 TOP): " +
            game.drawEdge(coord21, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,1 BOTTOM): " +
            game.drawEdge(coord21, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 2,1): " +
            game.getOwnerAt(coord21));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,2 LEFT): " +
            game.drawEdge(coord02, Direction.LEFT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 0,2 RIGHT): " +
            game.drawEdge(coord02, Direction.RIGHT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,2 TOP): " +
            game.drawEdge(coord02, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 0,2 BOTTOM): " +
            game.drawEdge(coord02, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 0,2): " +
            game.getOwnerAt(coord02));
        ...
        System.out.println();
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,2 LEFT): " +
            game.drawEdge(coord12, Direction.LEFT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 1,2 RIGHT): " +
            game.drawEdge(coord12, Direction.RIGHT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 1,2 TOP): " +
            game.drawEdge(coord12, Direction.TOP));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 1,2 BOTTOM): " +
            game.drawEdge(coord12, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player One, 1,2): " +
            game.getOwnerAt(coord12));
        ...
        System.out.println();
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 2,2 LEFT): " +
            game.drawEdge(coord22, Direction.LEFT));
        System.out.println("Current Player: (ONE) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player One, 2,2 RIGHT): " +
            game.drawEdge(coord22, Direction.RIGHT));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,2 TOP): " +
            game.drawEdge(coord22, Direction.TOP));
        System.out.println("Current Player: (TWO) " + game.getCurrentPlayer());
        System.out.println("Draw Edge (Player Two, 2,2 BOTTOM): " +
            game.drawEdge(coord22, Direction.BOTTOM));
        System.out.println();
        System.out.println("BOX OWNER (Player Two, 2,2): " +
            game.getOwnerAt(coord22));
