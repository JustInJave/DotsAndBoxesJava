...
public class DABGame implements DotsAndBoxes {
    ...
    /**
     *
     * Construct a new DABGame object. The constructor has no arguments and does not initialize a
     * new game.
     *
     */
    public DABGame() {
    ...
    /**
     *
     * Find Box in Box class There are three places where we receive coordinates: drawEdge,
     * getDrawnEdgesAt, getOwnerAt.
     *
