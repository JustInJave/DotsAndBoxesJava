...
public class Box {
    ...
    /**
     *
     * Get the Collection of edges drawn at any given time in the game.
     *
     * @return drawnEdges
     *
     */
     ...
     *
     * BOTTOM - Indicates the bottom edge. LEFT - Indicates the left edge. RIGHT - Indicates the
     * right edge. TOP - Indicates the top edge.
     *
    ...
    /**
     *
     * The drawn line represents one edge of at least one box. Note that each edge is shared between
     * two neighboring boxes, except for boxes located along the outer-most grid boundaries.
     *
     * @param dir direction of line drawn
